...
public class Lesson3 {
  ...
  static int[][] computeLevenshtein(List<String> wordList, boolean parallel) {
    ...
    // YOUR CODE HERE
    wordStream(wordList, parallel)
            .map(firstPassWord -> wordStream(wordList, parallel)
                                          .mapToInt(secondPassWord -> Levenshtein.lev(firstPassWord, secondPassWord))
                                          .toArray())
...
//    }
  ...
  private static Stream<String> wordStream(List<String> wordList, boolean parallel)
  {
  ...
  static List<String> processWords(List<String> wordList, boolean parallel) {
    // YOUR CODE HERE
    List<String> result = wordStream(wordList, parallel)
